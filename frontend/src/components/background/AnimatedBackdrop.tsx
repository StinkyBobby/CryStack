...
export function AnimatedBackdrop() {
  return (
    <>
      ...
      <div className="pointer-events-none absolute inset-0 z-[1] bg-[radial-gradient(circle_at_20%_12%,rgba(236,72,153,0.20),transparent_40%),radial-gradient(circle_at_85%_16%,rgba(56,189,248,0.20),transparent_36%),linear-gradient(180deg,rgba(2,6,23,0.25)_0%,rgba(2,6,23,0.96)_68%)]" />
      <div className="noise-overlay pointer-events-none absolute inset-0 z-[2]" />

      <div className="floating-blob pointer-events-none absolute -left-20 top-8 z-[2] h-64 w-64 rounded-full bg-fuchsia-500/20 blur-3xl" />
      <div className="floating-blob-delayed pointer-events-none absolute -right-12 bottom-24 z-[2] h-56 w-56 rounded-full bg-sky-500/25 blur-3xl" />
    </>
  );
}
